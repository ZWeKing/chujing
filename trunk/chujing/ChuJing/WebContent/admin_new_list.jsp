...
<table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000066" width="90%">
  <tr>
    <td width="20%" class="to_ope_cell"><input type="button" onClick="" value="添加新闻"/></td>
    <td><table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
      <tr>
		...
		<option value="NEWS_TITLE LIKE">新闻标题中有</option>
...
<table width="90%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000066">
  <tr>
	...
	<span class="menu_font_big">新闻列表</span>
	</td>
  </tr>
  <tr>
    <td colspan="2">
	<table border="1" align="center" width="100%" height="100%" bordercolor="#000066" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td class="head_title_3" width="20%"><span class="menu_font_small">新闻ID号</span></td>
        ...
        <td class="head_title_3" width="20%"><span class="menu_font_small">修改日期</span></td>
        <td class="head_title_3" width="20%" colspan="2"><span class="menu_font_small">操作</span></td>
        </tr>
		      <tr>
        <td class="td_cell" width="20%"><span class="cell_font">新闻ID号</span></td>
        <td class="td_cell"width="20%"><span class="cell_font">新闻标题</span></td>
        <td class="td_cell"width="20%"><span class="cell_font">创建日期</span></td>
        <td class="td_cell"width="20%"><span class="cell_font">修改日期</span></td>
