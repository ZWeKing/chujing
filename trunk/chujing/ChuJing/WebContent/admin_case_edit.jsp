...
<body>
<form name="case_edit_form" action="" method="post" enctype="multipart/form-data">
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000066">
  ...
  <tr>
    <td>
	<table cellpadding="0" cellspacing="0" width="100%" border="1" bordercolor="#000066">
	<tr>
	<td width="50%">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100%" class="head_title_3"><span class="note_font_red">由于资源上传量大，可能上传时间较长！</span></td>
  </tr>
</table>
	</td>
	</tr>
